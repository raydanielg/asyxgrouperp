...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            ['name' => 'logistics_officer', 'label' => 'Logistics Officer', 'perms' => ['view-dashboard', 'view-warehouses', 'view-products', 'view-stock-movements', 'view-purchase-invoices', 'view-suppliers', 'view-transfers', 'view-projects', 'view-employees', 'view-attendance', 'view-reports', 'view-self-service', 'view-my-payslips']],
            ...
            ['name' => 'cashier', 'label' => 'Cashier', 'perms' => ['view-dashboard', 'view-pos', 'create-pos', 'view-sales-invoices', 'view-products', 'view-revenues', 'create-revenues', 'view-self-service', 'view-my-payslips']],
            ...
            ['name' => 'finance_officer', 'label' => 'Finance Officer', 'perms' => ['view-dashboard', 'view-sales-invoices', 'create-sales-invoices', 'edit-sales-invoices', 'view-purchase-invoices', 'create-purchase-invoices', 'edit-purchase-invoices', 'view-expenses', 'create-expenses', 'view-revenues', 'create-revenues', 'view-bills', 'create-bills', 'view-bank-accounts', 'create-bank-accounts', 'view-acc-transfers', 'create-acc-transfers', 'view-reports', 'view-self-service', 'view-my-payslips']],
        ];
