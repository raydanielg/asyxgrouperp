...
class RoleDashboardController extends Controller
{
    ...
    private function getQuickActionsForRole(string $role): array
    {
        return match ($role) {
            ...
            'finance_officer', 'finance_manager', 'chief_accountant', 'accountant', 'accounts_receivable_officer', 'accounts_payable_officer', 'payroll_officer', 'budget_officer', 'credit_controller' => [
                ...
                ['label' => 'Journal Entries', 'route' => 'admin.expenses.index', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
            ],
            'hr_officer' => [
    ...
    private function getSecondaryKpisForRole(string $role, array $stats): array
    {
        ...
        return match ($role) {
            'erp_super_administrator' => [
                ['label' => 'Group Companies', 'value' => $stats['groupCompanies'] ?? 0, 'color' => 'emerald', 'route' => 'admin.companies.index'],
                ['label' => 'Subsidiaries', 'value' => $stats['subsidiaryCompanies'] ?? 0, 'color' => 'sky', 'route' => 'admin.companies.index'],
                ['label' => 'Employees', 'value' => $stats['totalEmployees'] ?? 0, 'color' => 'violet', 'route' => 'admin.employees.index'],
                ['label' => 'Active Projects', 'value' => $stats['activeProjects'] ?? 0, 'color' => 'amber', 'route' => 'admin.projects.index'],
                ['label' => 'Pending Leaves', 'value' => $stats['pendingLeaves'] ?? 0, 'color' => 'rose', 'route' => 'admin.leaves.index'],
