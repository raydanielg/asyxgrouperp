...
class RolePageController extends Controller
{
    ...
    private function getAllowedModulesForRole(string $role): array
    {
        return match ($role) {
            ...
            'director' => ['reports', 'projects', 'sales-dashboard', 'employees', 'sales-invoices', 'purchase-invoices', 'expenses', 'tickets', 'payslips', 'salary'],
            'finance_officer' => ['sales-invoices', 'purchase-invoices', 'expenses', 'revenues', 'bills', 'bank-accounts', 'transfers', 'salary-advance', 'reports', 'payslips', 'salary'],
            'hr_officer' => ['employees', 'attendance', 'payroll', 'leaves', 'performance', 'training', 'recruitment', 'assets', 'policies', 'payslips', 'salary'],
            'auditor' => ['sales-invoices', 'purchase-invoices', 'expenses', 'revenues', 'bills', 'bank-accounts', 'reports', 'warehouses', 'products', 'stock-movements', 'pos', 'payslips', 'salary'],
            'admin_manager' => ['users', 'roles', 'employees', 'attendance', 'leaves', 'reports', 'settings', 'payslips', 'salary'],
            'cashier' => ['pos', 'pos-reports', 'sales-invoices', 'products', 'revenues', 'payslips', 'salary'],
            'technical_manager' => ['tickets', 'projects', 'timesheets', 'bugs', 'employees', 'payslips', 'salary'],
            'technician' => ['tickets', 'projects', 'timesheets', 'bugs', 'payslips', 'salary'],
            'ict_officer' => ['tickets', 'projects', 'bugs', 'assets', 'employees', 'payslips', 'salary'],
            'ict_engineer' => ['tickets', 'projects', 'bugs', 'assets', 'settings', 'payslips', 'salary'],
            'project_manager' => ['projects', 'timesheets', 'bugs', 'deals', 'reports', 'payslips', 'salary'],
            'operations_manager' => ['products', 'warehouses', 'stock-movements', 'sales-invoices', 'purchase-invoices', 'projects', 'reports', 'payslips', 'salary'],
            'logistics_officer' => ['products', 'warehouses', 'stock-movements', 'suppliers', 'inventory-transfers', 'purchase-invoices', 'payslips', 'salary'],
            ...
            'call_center_agent' => ['leads', 'contacts', 'tickets', 'payslips', 'salary'],
            'legal_officer' => ['contracts', 'contacts', 'projects', 'reports', 'payslips', 'salary'],
            'supervisor' => ['employees', 'attendance', 'leaves', 'projects', 'pos', 'products', 'reports', 'payslips', 'salary'],
            'administrator' => ['users', 'roles', 'employees', 'projects', 'products', 'settings', 'reports', 'payslips', 'salary'],
