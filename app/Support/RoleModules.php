...
class RoleModules
{
    ...
    private const CURATED = [
        ...
        'erp_super_administrator' => ['dashboard', 'companies', 'consolidated', 'users', 'login-history', 'roles', 'employees', 'projects', 'products', 'sales-invoices', 'tickets', 'settings', 'system-control', 'database-backup', 'audit-logs', 'reports', 'my-account', 'payslips', 'salary'],
