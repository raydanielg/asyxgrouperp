...
<div class="animate-fade">
  <div class="bg-amber-50 border border-amber-200 text-amber-800 rounded-xl p-4 mb-5 text-sm flex items-start gap-3">
    <svg class="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/></svg>
    <div>
      <p class="font-semibold">Permissions are hardcoded</p>
      <p class="text-xs mt-0.5">Access control for each role is now defined directly in code (<code class="bg-amber-100 px-1 rounded">app/Support/RolePermissions.php</code>). Editing permissions below no longer changes what a role can actually access — edit that file to change access.</p>
    </div>
  </div>
  {{-- Stats Cards --}}
  @php
