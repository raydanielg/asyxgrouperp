...
<div class="bg-white rounded-xl border overflow-hidden">
    <div class="px-5 py-4 border-b bg-gray-50/50">
        <form method="GET" action="{{ route('admin.roles.index') }}" class="flex items-center gap-3">
            ...
            @if(request('name'))<a href="{{ route('admin.roles.index') }}" class="text-xs text-gray-500 hover:text-gray-700">Clear</a>@endif
        </form>
    </div>
                ...
                <tr class="border-t border-gray-100 hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-5 py-3">
                        <div class="flex flex-wrap gap-1">
                            ...
                            @endif
                            @if($role->users->isEmpty())<span class="text-[10px] text-gray-400">No users</span>@endif
                        </div>
                    </td>
