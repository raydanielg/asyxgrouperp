    ...
    <div class="bg-white rounded-xl border p-6">
        ...
        <form method="POST" action="{{ route('admin.settings.update') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div><label class="block text-xs font-medium text-gray-600 mb-1">Default Currency</label><input name="defaultCurrency" value="{{ old('defaultCurrency', \App\Models\Setting::get('defaultCurrency', 'USD')) }}" class="w-full px-3 py-2 rounded-lg border border-gray-200 text-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none"></div>
            </div>
            <div class="grid grid-cols-2 gap-4">
