    ...
    <div class="lg:col-span-2 space-y-4">
        ...
        <div class="bg-white rounded-xl border p-6">
            ...
            <div class="overflow-x-auto"><table class="w-full text-xs">
                ...
                </tr>@empty<tr><td colspan="5" class="py-4 text-center text-gray-400">No assigned tasks</td></tr>@endforelse</tbody>
            </table></div>
        </div>
        ...
        <div class="bg-white rounded-xl border p-6">
            ...
            @empty<p class="text-xs text-gray-400 text-center py-4">No performance reviews</p>@endforelse</div>
        </div>
