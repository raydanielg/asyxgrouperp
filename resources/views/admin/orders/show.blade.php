...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border p-6">
        ...
        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-emerald-50 text-emerald-700 border border-emerald-100">Succeeded</span>
        ...
        @else
        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-50 text-red-700 border border-red-100">{{ ucfirst($order->payment_status) }}</span>
        @endif
        </div>
