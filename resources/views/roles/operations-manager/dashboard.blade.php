...
@section('title', 'Operations Manager Dashboard')
@section('page_title', 'Operations Manager Dashboard')
@section('content')
...
<div class="bg-gradient-to-r from-emerald-700 to-emerald-900 rounded-xl p-6 mb-6 text-white relative overflow-hidden">
    ...
    <div class="relative z-10 flex items-center justify-between">
        <div><h2 class="text-2xl font-bold">Welcome, {{ auth()->user()->name }}</h2><p class="text-emerald-100 text-sm mt-1">Operations Manager Dashboard</p></div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="bg-white rounded-xl border p-5">
        ...
        <a href="{{ route($action['route'], $action['params'] ?? []) }}" class="flex items-center gap-3 px-4 py-2.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-lg text-xs font-medium transition-colors">
...
@if(!empty($recentItems['recentAttendance']))
    <div class="bg-white rounded-xl border overflow-hidden">
        <div class="px-5 py-4 border-b flex items-center justify-between">
            ...
            <a href="{{ route('role.page', ['module' => 'attendance']) }}" class="text-[10px] text-emerald-600 hover:text-emerald-700">View All</a>
        </div>
        <div class="divide-y divide-gray-100">
