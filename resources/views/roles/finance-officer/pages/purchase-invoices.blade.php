...
$description = 'Vendor purchase invoices and totals.';
@endphp
...
@include('roles.finance-officer.pages._actions', ['module' => 'purchase-invoices'])
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50">
                    ...
                    <td class="px-4 py-3 text-xs text-gray-600">{{ $invoice->vendor?->name ?? '-' }}</td>
                ...
                @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-xs text-gray-400">No purchase invoices found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
