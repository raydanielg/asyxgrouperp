...
@section('title', 'Call Center Agent Dashboard')
@section('page_title', 'Call Center Agent Dashboard')
@section('content')
...
<div class="bg-gradient-to-r from-emerald-700 to-emerald-900 rounded-xl p-6 mb-6 text-white relative overflow-hidden">
    ...
    <div class="relative z-10 flex items-center justify-between">
        <div><h2 class="text-2xl font-bold">Welcome, {{ auth()->user()->name }}</h2><p class="text-emerald-100 text-sm mt-1">Call Center Agent Dashboard</p></div>
