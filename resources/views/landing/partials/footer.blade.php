<footer id="contact" class="bg-gray-900 text-gray-400 pt-20 pb-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
            {{-- Brand --}}
            <div class="col-span-2">
                <div class="flex items-center gap-2 mb-4">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-500 to-emerald-700 flex items-center justify-center shadow-lg">
                        <span class="text-white font-black text-lg">A</span>
                    </div>
                    <div class="flex flex-col leading-none">
                        <span class="font-black text-lg text-white">ASYX<span class="text-emerald-500">Group</span></span>
                        <span class="text-[10px] font-medium text-gray-500 tracking-wider uppercase">Enterprise Suite</span>
                    </div>
                </div>
                <p class="text-sm leading-relaxed max-w-sm mb-6">
                    Integrated ERP, CRM, HRM, and Business Flow management platform designed for modern enterprises. Manage every department from a single dashboard.
                </p>
                <div class="flex items-center gap-3">
                    <a href="#" class="w-9 h-9 rounded-lg bg-white/5 hover:bg-emerald-600 flex items-center justify-center transition-colors">
            ...
            {{-- Modules --}}
            <div>
                <h4 class="text-white font-bold text-sm mb-4">Modules</h4>
                <ul class="space-y-2.5 text-sm">
                    <li><a href="#" class="hover:text-emerald-400 transition-colors">HRM</a></li>
                    <li><a href="#" class="hover:text-emerald-400 transition-colors">CRM</a></li>
                    <li><a href="#" class="hover:text-emerald-400 transition-colors">Accounting</a></li>
                    <li><a href="#" class="hover:text-emerald-400 transition-colors">Inventory</a></li>
                    <li><a href="#" class="hover:text-emerald-400 transition-colors">Projects</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    ...
                    <li><a href="#modules" class="hover:text-emerald-400 transition-colors">All Modules</a></li>
                    <li><a href="{{ route('login') }}" class="hover:text-emerald-400 transition-colors">Sign In</a></li>
                </ul>
            </div>

            {{-- Contact --}}
            <div>
                <h4 class="text-white font-bold text-sm mb-4">Get in Touch</h4>
        ...
        <div class="pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-xs text-gray-500">
                &copy; {{ date('Y') }} ASYX Group. All rights reserved. Powered by Laravel 13.
            </p>
