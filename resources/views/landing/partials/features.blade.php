<section id="services" class="py-20 lg:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center max-w-2xl mx-auto mb-16">
            <span class="inline-block px-4 py-1.5 rounded-full bg-bronze/10 text-bronze text-xs font-bold uppercase tracking-wider mb-4">02 Core Service Pillars</span>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">IoT, AI-driven analytics, and intelligent automation systems that optimise operations across critical infrastructure.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Real-time vehicle tracking, fleet management, and geospatial intelligence for transport and aviation clients.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Enterprise-grade protection for networks, endpoints and critical data - safeguarding mission-critical systems.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Custom enterprise applications, ERP systems, and digital transformation platforms built for scale and reliability.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Server rooms, fibre/network cabling, data centres, and connectivity solutions engineered for mission-critical uptime.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Servers, networking equipment, workstations, and specialised hardware procurement with enterprise-grade warranties.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">24/7 monitoring, maintenance, and support - ensuring your systems run at peak performance without interruption.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Skilled IT personnel deployment, technical staffing, and outsourced operations management for any scale.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
            ...
            <div class="card-hover bg-white rounded-2xl p-7 border border-gray-100 shadow-sm">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">Technology capacity building, certification programs, and skills transfer for government and enterprise teams.</p>
                <a href="{{ route('services') }}" class="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-bronze hover:text-purple transition-colors">Learn more <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg></a>
            </div>
        </div>
    </div>
