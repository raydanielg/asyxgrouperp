...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'route-permission'])->group(function () {
    ...
    Route::get('/projects/{project}/expense-requests', [$ext, 'projectExpenseRequestIndex'])->name('projects.expense-requests');
    Route::post('/projects/{project}/expense-requests', [$ext, 'projectExpenseRequestStore'])->name('projects.expense-requests.store');
    Route::post('/expense-requests/{expenseRequest}/approve', [$ext, 'projectExpenseRequestApprove'])->name('projects.expense-requests.approve');
    Route::post('/expense-requests/{expenseRequest}/reject', [$ext, 'projectExpenseRequestReject'])->name('projects.expense-requests.reject');
